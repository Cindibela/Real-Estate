...
B. Service Rules. You will use the Service strictly in accordance with these Terms, all Documentation, the Privacy Policy, and Applicable Law. You will not engage in any of the following activities:
...
I. Property Data Restrictions. In addition to other restrictions herein, for the avoidance of doubt, all property data provided on the Service is for your personal, sole and private, non-commercial use and not available for redistribution, retransmission or copying. You may not sell or use such data for any purpose, other than the purpose of attempting to evaluate properties or properties for sale or purchase. You acknowledge that the MLS data on the Service is owned by the respective MLS, and you acknowledge the validity of the MLS's copyright to such data.</li>
...
C. Maps. The Service may feature Microsoft Bing Maps and Google Maps. Use of Microsoft Bing Maps is subject to the Bing Maps Terms of Use and use of Google Maps is subject to the Google Maps Terms of Use and Privacy Policy. Such services are not under the control of Affiliated Entities. Please review the terms of use or privacy policies of these services for rights and restrictions.</li>
...
B. Your Ownership Rights. As between you and us, and subject to Sections 3(B) and 4(A) above, you own all right, title and interest in and to your Content.</li>

 <h5>Data </h5>
 <li>You agree that the Affiliated Entities, including us, may collect, store, use, and distribute information in accordance with the Privacy Policy, including in respect of your information and data. You will comply with the Privacy Policy.</li>

 <h5>Compliance</h5> 
 <li>We do not provide compliance services. You agree that the Service is provided for your convenience only, and not for purposes of enabling you to meet your obligations under Applicable Law and third party agreements. You are solely responsible for ensuring compliance with such obligations.</li>

 <h5>Payment</h5>
 <li>If any amounts are due hereunder, you will pay us in accordance with statements issued by us or otherwise as agreed within the Service. Pricing for any portion of the Service is subject to change upon our notice. Pricing excludes, and you will pay, all taxes, but neither party will pay income taxes of the other party. For any amount you fail to pay by its due date, we may charge you a late penalty on the amount overdue each day it is overdue until it is paid, equal to the lesser of (a) the maximum legally permissible interest rate, and (b) an interest rate of five percent (5%), which reflects the cost of our efforts to collect your payment. You will pay amounts through the means determined by us, including without limitation through a payment service provided by us or a PSP. If a PSP is used, you may also be required to register with the PSP, agree to the PSP's terms of service and privacy policies, and go through a vetting process at the request of the PSP. Please note we are not a party to the PSP's terms of service and privacy policies and we have no obligations or liability to you under any such terms or policies.</li>
...
Our obligations with respect to your Confidential Information under these Terms are subject to the Privacy Policy.</li>

<li> Termination.
These Terms will continue in full effect unless and until your Account or these Terms is terminated as described herein. We may terminate these Terms for convenience upon notice. Upon termination of the Agreement, the rights and licenses granted to you hereunder will immediately terminate. Upon termination of these Terms, you grant to us a non-exclusive, non-sublicenseable, non-transferable, irrevocable, and perpetual license to use the data and information collected by the Service under your Account during the term of these Terms, and to use such data and information in accordance with the Privacy Policy.</li>

<li> Third Party Beneficiary.
These Terms do not and is not intended to confer any rights or remedies upon any person other than the parties and as otherwise expressly stated herein.</li>

<li> Assignment.
These Terms, and any rights and licenses granted hereunder, may not be transferred or assigned by you without our prior written consent, but may be assigned by us without restriction. Any attempted transfer or assignment in violation hereof will be null and void.</li>
</ol>
<h3> General</h3>
<ul>
<li>Nature of Relationship. The relationship of the parties under these Terms will be that of independent contractors. Neither these Terms as a whole or any part of these Terms will render either party the agent, representative, servant, or employee of the other party. Neither party has the power, express or implied, to bind the other party in any manner or to make representations on behalf of the other party regarding any matter. Except as stated in the Agreement, we will in no way be restricted from using or commercializing all or any portion of the Service or performing or receiving any services from any third party including services the same as or similar to Service provided or received in connection with these Terms.</li>



<li> AGREEMENT TO ARBITRATE DISPUTES.
...
OPT-OUT OF AGREEMENT TO ARBITRATE: You can decline this agreement to arbitrate by emailing us at team@attlasgroup.com and providing the requested information as follows: (1)Your Name; (2) the URL of Terms of Use and Agreement to Arbitrate Disputes; (3) Your Address; (4) Your Phone Number; (5) and clear statement that you wish to opt out of this arbitration provision in the Terms of Use. The Opt-Out Notice must be emailed no later than 30 days after the date you first accept the Terms of Use by using the website.
...
<li> Notices. All notices and other communications to be given to any party hereunder will be sufficient for all purposes hereunder if in writing, properly addressed as set forth below in this section and delivered (a) by hand or courier (delivery of notice deemed to occur upon delivery), (b) if sent electronically on the date delivered to the authorized email address, (c) by overnight delivery service (delivery of notice deemed to occur upon delivery and written confirmation thereof by such service), (d) by certified or registered mail, return receipt requested, with appropriate postage prepaid (delivery of notice deemed to occur upon signature of the receipt by the recipient), or (e) if from us to you, posted to your Account OR the Service on the date noted by us. If to us, notices may be sent to @attlasgroup.com If to you, your email and mailing address as identified in our records.</li>
<li>Headings; Interpretation. Section headings used in these Terms are used for convenience only and are not to be considered in construing or interpreting these Terms. As used herein, "including" means "including without limitation."</li>
<li> Severability. The provisions of the Terms and Conditions are intended to be interpreted in a manner which makes them valid, legal, and enforceable. In the event any provision of the Terms and Conditions is found to be partially or wholly invalid, illegal or unenforceable, such provision shall be modified or restricted to the extent and in the manner necessary to render it valid, legal, and enforceable. It is expressly understood and agreed between the parties that such modification or restriction may be accomplished unilaterally by us, or alternatively, by disposition of an arbitrator or a court of law. If such provision cannot under any circumstances be so modified or restricted, it shall be excised from the Terms without affecting the validity, legality or enforceability of any of the remaining provisions.</li>

<li> Waiver. A waiver of any provision of these Terms must be made in writing to be effective, and our waiver of a breach of any provision or right contained in these Terms will not constitute a continuing waiver or waive any subsequent breach or right.</li>

<li> Force Majeure Except with respect to your payment obligations, neither party will be liable for failures or delays in the performance of its obligations hereunder due to causes beyond its reasonable control, including, in respect of the provision of the Service, failures or delays caused by our service providers, any act of God, terrorist attacks, inclement weather, accidental damage, vandalism, failure or shortage or power supplies, flood, drought, lightning or fire, strike, lock-out, trade dispute or labor disturbance, or any act or omission of government or other competent authorities.</li>

<li>Entire Agreement These Terms, and documents incorporated herein, comprises the entire agreement between us and you and supersedes all prior or contemporaneous negotiations, discussions, or agreements, whether written or oral, between the parties regarding its subject matter.</li>
<li> Survival Sections 1, 2(E), 2(F), 2(G), 2(I), 3(B), 4-17 will survive any termination or expiration of these Terms.</li>
...
<li>"Account" means the account provided by us that you to manage and access the Service.</li>
<li>"Affiliated Entities" means, collectively, us, Brand and our and Brand's parent, subsidiaries, affiliates, and, where applicable, our and their service providers and licensors.</li>
<li> "Agent" means a real estate-broker, salesperson, agent, associate broker, or similar state licensed real-estate professional licensed with one of our franchisees.</li>
<li>"App" means a mobile application that may be provided as part of the Service.</li>
<li>"Applicable Law" means any statute, law, ordinance, rule, regulation, or requirement of a governmental entity that applies to a party or its business.</li>
<li>"Claim" means, collectively, claims, costs, damages, losses, liabilities, Fines, and expenses (including reasonable attorneys' fees and costs).</li>
<li>"Communications" means parts of the Service that includes electronic communications services, and document storage and management services, all as provided by us (or, at your selection, by a third party through a Third Party Product) for your use.</li>
...
<li>"Content" means any content, data or information provided by a party for inclusion in the Service or uploaded to, transmitted or submitted by a party through the Service, including Communications.</li>
<li> "Documentation" means the technical and operational documentation made available to you by us regarding any portion of the Service.</li>
<li>"Feedback" means ideas, suggestions, or recommendations on the Service provided by you.</li>
<li>"Fine" means any and all fines, penalties, refunds, charges, debits, deductions, legal fees and costs incurred by or other sums payable to any party.</li>
...
<li>"Marks" means an Affiliated Entity's proprietary trademarks, trade names, and service marks, including registrations and applications for registrations thereof and all renewals, modifications and extensions thereof.</li>
<li>"MLS Feed" means a local listing service ("MLS") feed(s) provided through the Service.</li>
 "Privacy Policy" means the privacy policy for a Website or App and other portions of the Service, as provided and modified by us from time to time in our discretion.</li>
 <li>"PSP" means a third party payment service provider selected by us.</li>
 "Service" means our hosted service (including Websites and Apps), software, Documentation, and any services made available to you by us hereunder, all as may be modified by us from time to time in our discretion.</li>
 <li>"Third Party Products" means the third party applications and/or services, if any, which may be offered, made available or integrated by us to you for use as part of, or in connection with the Service.</li>
 <li>"User" means other users of the Service.</li>
 <li>"User Ratings" means a feature on the Service where you can rate and review various matters, including Agents.</li>
 <li> "User Ratings Guidelines" means the rules, together with these Terms, that governs the use of User Ratings.</li>
 <li> "We," "our," and "us" means us and Brand.</li>
 <li> "Website" means a website that may be provided by us as part of the Service.</li>
 <li>"You" and "your" means the individual entering into these Terms with us.</li>
