            ...
            <table id="table" class="table table-flush" style="width:100%">
              <thead class="thead-light">
                <tr>
                  ...
                  <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">Location</a>
                  </th>
                  <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">ZipCode</a>
                  </th>
                  <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">Join As</a>
                  </th>
                  <th data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">Gender</a>
                  </th>
              ...
              <tbody>
                ...
                <?php
                  ...
                  $n_query = mysqli_query($con,"select * from jobs where email = '$email'");
                ...
                <tr>
                  ...
                  <td class="align-middle text-center">
                    <p class="text-xs font-weight-bold mb-0"><?php echo $row['zipcode'] ?></p>
                   </td>
                   <td class="text-sm font-weight-normal text-center"><?php echo $row['join_as'] ?></td>
                   <td class="align-middle text-center">
